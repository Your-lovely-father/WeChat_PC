    ...
    <div class="about">
      ...
      <div class="info">
        ...
        <div class="info-item">
          ...
          <span>信息工程(2018毕业)</span>
        </div>
        <div class="info-item">
          <i class="icon phone"></i>
          <span>15942999924</span>
        </div>
        <div class="info-item">
          <i class="icon email"></i>
          <span>95241616@qq.com</span>
        </div>
      </div>
    </div>
    <div class="power">
      <div class="power-item">
        ...
        <div class="technology-item">
          <span>【 前 端 】</span>HTML/HTML5 &nbsp CSS/CSS3 &nbsp JavaScript(ES6,ES5) &nbsp SASS &nbsp Stylus &nbsp Vue.JS &nbsp AJAX &nbsp jQuery
        </div>
        <div class="technology-item">
      ...
      <div class="power-item">
        ...
        <div class="myevaluation">
          本人抗压能力强，能独立思考，独立解决问题，也会经常逛技术社区，学习好的分享技术.技术发展太快，
          我会以更开发的心态去接受新技术，不断扩展自己。
          我相信自己可以做好本职工作。我相信自己可以很快的融入公司的技术团队。
        </div>
      </div>
    </div>
  </div>
